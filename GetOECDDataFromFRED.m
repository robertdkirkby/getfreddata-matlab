function [DateVector, DataMatrix, CountryCodes]=GetOECDDataFromFRED(code1, code2, justcountries, observation_start, observation_end, units, frequency, aggregation_method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
